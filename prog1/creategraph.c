...
float threshold(int n, int d) {
    if (d == 0) {
        return 5.0 / (0.10523204120493665 * n + 21.197763419973427) + 0.0015;
    } else if (d == 2) {
        return 2.0 / (0.16517538261952885 * n + 22.97229280304088) + 0.03;
    } else if (d == 3) {
        return 1.5 / (0.23458454621312719 * n + 35.856196376448942) + 0.1;
    } else if (d == 4) {
        return 1.2 / (0.24600034088745676 * n + 18.665592765194326) + 0.15;
    }
